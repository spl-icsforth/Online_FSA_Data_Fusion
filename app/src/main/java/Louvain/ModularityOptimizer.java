...
public class ModularityOptimizer
{
	public static void main(String[] args) {
		String[] arguments = new String[] {"files/karate.txt", "files/communities.txt", "1", "1.0", "1", "10", "10", "0", "1"};
		try {
			runOptimizer(new String[] {"files/iris.txt", "files/communities.txt", "1", "1.0", "1", "10", "10", "0", "1"});
		} catch (IOException e) {
    ...
    public static ArrayList<Integer> runOptimizer(String[] args) throws IOException
    {
        ...
        int[] clust = clustering.getClusters();
        ArrayList<Integer> clusters =  new ArrayList<Integer>();
        for (int k=0; k<clust.length; k++) 
        	clusters.add(clust[k]);
